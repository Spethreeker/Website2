...
<?php include 'includes/navbar.inc';?>
    ...
    <section>
        ...
        <div class="notification">
            <h1 class="subtitle is-3 has-text-centered">Our Location</h1>
        </div>
        <div class="notification is-white">
            <div class="columns">
                <div class="column notification is-white has-text-centered">
                    <h1 class="title">We are located at 109 South Davis Avenue, Cleveland Mississippi.</h1>
                 <div id="map"></div>
                </div>    
            </div>
        </div>
...
<script>
    function navtoggle() {
     ...
     function initMap() {
        var uluru = {lat: 33.7434219, lng: -90.7157};
        ...
        '<p class="subtitle">109 South Davis Avenue</p>'+'</div>';
  ...
  map.addListener('mouseover', function() {
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAmAghIiEJ1xYwmsOZV2NSBdCcPV1sLJy8&callback=initMap">
    </script>
